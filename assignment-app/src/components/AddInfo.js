            ...
            <div className='container'>
                <div className='form-style'>
                    <form onSubmit={this.handleSubmit} >
                        ...
                        <div className='form-group'>
                            <input type="date" id='birth' placeholder='Birthday' value={this.state.birth} onChange={this.handleChange} />
                        </div>
                        <div className='form-group'>
                        ...
                        <button className='btn' data-toggle='tooltip' data-placement='right' title='Click Here To Submit'>Submit</button>
                    </form>
                </div>
            </div>
        )
